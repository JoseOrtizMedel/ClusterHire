...
from .views import home, nueva_oferta, ofertas_admin, ofertas_user, perfil, perfilCompe, perfilDire, perfilEduc, perfilExp, register, login, eliminar_oferta, formulario, perfilPers
