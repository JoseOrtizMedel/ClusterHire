...
from .models import Ciudad, Competencia, CompetenciaUsuario, Comuna, Direccion, Educacion, Experiencia, FormacionAcademica, Formulario, Habilidad, HabilidadUsuario, Idioma, IdiomaUsuario, Institucion, LogroAcademico, Oferta, TipoCargo, TipoEmpleo, TituloProf, Usuario, UsuarioLogro, ModalidadTrabajo
